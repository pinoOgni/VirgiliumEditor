...
public:
    ...
    FileManagementMessage(quintptr sender, QString email, QString filename, QString oldfilename,
                          QString password); //rename_file
    FileManagementMessage(quintptr sender, QString email, QString filename,
                          QString password);  //new_file and delete_file
